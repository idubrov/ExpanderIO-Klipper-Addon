...
import pins
from . import bus, eio_i2c_inputs
...
class EioSX1509(eio_i2c_inputs.EioI2cInputs):
    def __init__(self, config):
        ...
        self._ppins.register_chip("eio_sx1509_" + self._name, self)
    ...
    def handle_connect(self):
        ...
        for _reg, _data in list(self.reg_dict.items()) + list(
            self.reg_i_on_dict.items()
        ):
